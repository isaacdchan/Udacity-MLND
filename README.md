...
They are written in Python 2.7, using Jupyter Notebooks. My capstone project uses computer vision and clustering to detect and label standardized video game objects.
